...
| Файл | Описание |
|------|----------|
| `README.md` | Основное описание проекта, схема распределения ролей, обработка заявок, обоснование |
| `tech-support-scheme.png` | Основная схема: три линии техподдержки с распределением 7 ролей |
| `tech-support-cases.png` | Схема обработки 6 типов заявок с вариантами маршрутизации |
| `tech-support-scheme.drawio` | Исходный файл схемы (draw.io) — можно открыть и редактировать |
